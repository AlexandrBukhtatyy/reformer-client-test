...
// Enums and union types for select options
...
export interface InsuranceApplicationForm {
  ...
  minDriverAge: number | undefined;
  minDriverExperience: number | undefined;
  beneficiaries: Beneficiary[];
  totalBeneficiaryShare: number | undefined;
...
// Default form values
export const defaultFormValues: InsuranceApplicationForm = {
  // Step 1
  insuranceType: 'casco',
  insurancePeriod: 12,
  startDate: '',
  ...
  beneficiaries: [],
  totalBeneficiaryShare: undefined,
  ...
  ageCoefficient: undefined,
  experienceCoefficient: undefined,
  regionCoefficient: undefined,
  claimsCoefficient: undefined,
  deductibleDiscount: undefined,
  promoDiscount: undefined,
  multiPolicyDiscount: undefined,
